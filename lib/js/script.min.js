...
function startNewGame() {
  // APP ID
    if (!connected) return $("#theDimmer").html('Error: Not connected!<br><a href="https://www.moneypot.com/oauth/authorize?app_id=1392&response_type=token&state=Meh&redirect_uri=https://cooldice7.github.io">Click here to login</a>'), void $("#game_left").dimmer("show");
