...
function startNewGame() {
  // APP ID
    if (!connected) return $("#theDimmer").html('Error: Not connected!<br><a href="https://www.moneypot.com/oauth/authorize?app_id=2433&response_type=token&state=Meh&redirect_uri=https://deeprocks4.github.io">Click here to login</a>'), void $("#game_left").dimmer("show");
