...
function startNewGame() {
  // APP ID
    if (!connected) return $("#theDimmer").html('Error: Not connected!<br><a href="https://www.moneypot.com/oauth/authorize?app_id=1392&response_type=token&state=Meh&redirect_uri=https://deeprocks4.github.io">Click here to login</a>'), void $("#game_left").dimmer("show");
...
var _settings = {
    ...
    bombs: 13.024, // 3 bombs. Cannot be lower than 1 or higher than 24.
    multiply: 2, // Multiply the previous stake by 8 times if lost.
...
$("#bet").val(game.bet), $("#bombsButtons .button").each(function(a) {
    ...
    var a = "https://www.moneypot.com/dialog/deposit?app_id=1392",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
}), $("#withdrawButton").click(function() {
    var a = "https://www.moneypot.com/dialog/withdraw?app_id=1392",
        b = "manage-auth",
        c = "width=420,height=350,left=100,top=100",
        d = window.open(a, b, c);
    d.focus()
